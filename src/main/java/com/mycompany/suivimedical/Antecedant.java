...
@NamedQueries({
    ...
    @NamedQuery(name = "Antecedant.findByAntecedentPersonnel", query = "SELECT a FROM Antecedant a WHERE a.antecedentPersonnel = :antecedentPersonnel"),
...
public class Antecedant implements Serializable {
    ...
    @Size(max = 254)
    @Column(name = "antecedentPersonnel")
    private String antecedentPersonnel;
    @Size(max = 254)
    ...
    public String getAntecedentPersonnel() {
        return antecedentPersonnel;
    }

    public void setAntecedentPersonnel(String antecedentPersonnel) {
        this.antecedentPersonnel = antecedentPersonnel;
    }
    ...
    public String toString() {
        return "com.mycompany.suivimedical.Antecedant[ idDiagnostique=" + idDiagnostique + " ]";
    }
