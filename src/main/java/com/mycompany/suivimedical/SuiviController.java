...
public class SuiviController implements Serializable {
    ...
    @EJB
    private com.mycompany.suivimedical.SuiviFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setSuiviPK(new com.mycompany.suivimedical.SuiviPK());
    }
    ...
    public Suivi getSuivi(com.mycompany.suivimedical.SuiviPK id) {
    ...
    public static class SuiviControllerConverter implements Converter {
        ...
        com.mycompany.suivimedical.SuiviPK getKey(String value) {
            com.mycompany.suivimedical.SuiviPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.mycompany.suivimedical.SuiviPK();
            key.setIdPatient(Long.parseLong(values[0]));
            key.setIdMaladie(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(com.mycompany.suivimedical.SuiviPK value) {
