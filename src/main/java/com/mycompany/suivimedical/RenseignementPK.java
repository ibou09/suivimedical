 ...
 */
@Embeddable
public class RenseignementPK implements Serializable {
    ...
    public RenseignementPK() {
    }

    public RenseignementPK(int idMaladie, int idIndicateur, long idPatient) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RenseignementPK)) {
            return false;
        }
        RenseignementPK other = (RenseignementPK) object;
    ...
    public String toString() {
        return "com.mycompany.suivimedical.RenseignementPK[ idMaladie=" + idMaladie + ", idIndicateur=" + idIndicateur + ", idPatient=" + idPatient + " ]";
    }
